...
public class CollectableSpawner : MonoBehaviour
{
    ...
    //I will get these values from empty gameobjects we created by referencing x and y values.
    public GameObject lowestYSpawn;
    public GameObject highestYSpawn;

    //These are public variables to allow me to drag and drop prefabs
    ...
    //need a reference to time to determine how often to spawn a collectable
    private float time;
    ...
    void Update()
    {
        ...
        {
            spawnObject();
            //reset time so delay is set for the next object to spawn.
            time = 0f;
        }
    }
    ...
    private void spawnObject()
    {
        ...
        //the code below will return 0,1,2
